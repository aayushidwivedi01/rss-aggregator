...
public class XPathValidationTest extends TestCase{
	...
	public void testInValidXPath() {
		...
		assertFalse("XPath is invalid but output is true", xPathEngine.isValid(0));
	}
	
	//tests whether a valid xpath  containing contains(text(), "..") filter is correctly identified
	@Test
	...
	//tests whether a path containing invalid contains(text(), "..") filter is correctly identified
	@Test
	public void testXPathContainsInValid() {
		...
		assertFalse("XPath is valid but output is false", xPathEngine.isValid(0));
	}
	
	
	//tests whether a valid xpath  containing text = ".." filter is correctly identified
	@Test
	public void testXPathTextValid() {
		...
		assertTrue("XPath is invalid but output is true", xPathEngine.isValid(0));
	}
	
	//tests whether a valid xpath  containing @name = ".." filter  is correctly identified
	@Test
	...
	//tests whether apath containing invalid @name = ".." filter is correctly identified
	@Test
